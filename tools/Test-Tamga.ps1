...
if ($catalog) {
    ...
    if ($logos) {
        ...
        $localOverrides = @('CrystalDiskInfo','PerformanceTest','Buster','YouTube Auto HD + FPS','Win11Debloat','Bibata Modern Ice Cursor','PicView','NeoFreeBird','Windows Desktop Icons Installer')
        foreach ($app in $applications) {
